...
const PhoneCard = ({ phone, deletable, handleDelete }) => {
    ...
    return (
        <div className="card bg-base-100 shadow-sm">
            ...
            {deletable && <div onClick={() => handleDelete(id)} className='bg-gray-900 p-3 ml-5 rounded-full hover:bg-gray-300 group  cursor-pointer hover:scale-105 absolute -top-5 -right-5'><MdDeleteForever size={20}
